    ...
    return (
        <div className="hero-section text-center">
            ...
            <div className="container hero-text">
                ...
                <p className="lead">Growing Tomorrow's Food Today</p>
                <div className="hero-buttons">
                    <a href="#services" className="btn btn-primary btn-lg explore-btn">Explore Services</a>
                    <a onClick={handleAboutClick} className="btn btn-outline-light btn-lg contact-btn" style={{ cursor: 'pointer' }}>About Us</a>
                </div>
